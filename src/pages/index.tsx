  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Simplifying Reservations and Menu Management for Restaurants, Delivering Seamless Dining Experiences for Customers"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Simplifying Reservations and Menu Management for Restaurants, Delivering Seamless Dining Experiences for Customers`}
            </Text>
            <Box
